  ...
  <body>
		...
		<div class="main">
			...
			<div class="left">
				...
				<ul class="pagelist">
					<li>
						<a href="ShowNewsTypeAction?state=1&newsTypeId=${newsTypeId}&page=1&size=${pageModel.size}">首页</a>
					</li>
					<li>
						<a href="ShowNewsTypeAction?state=1&newsTypeId=${newsTypeId}&page=${pageModel.pre}&size=${pageModel.size}">上一页</a>" 
					</li>
					<li>
						<a href="ShowNewsTypeAction?state=1&newsTypeId=${newsTypeId}&page=${pageModel.next}&size=${pageModel.size}">下一页</a>"
					</li>
					<li>
						<a href="ShowNewsTypeAction?state=1&newsTypeId=${newsTypeId}&page=${pageModel.totalPage}&size=${pageModel.size}">末页</a>"
					</li>
					<li>
						<span class="pageinfo">
